...
//        //cp->freeInstance();
//        //cnp->freeInstance();
//        Project& proj2 = pf->addProject("comple","est il complet",Duration(40),QDate(1915,1,1),QDate(2200,6,3));
//        NonPreemptiveTask& prem5 = cnp->addTask("aaoooll","auchan",Duration(2,0),QDate(2010,1,1),QDate(2013,1,1));
//        proj2.addTask(prem5);
//        progF->scheduleTask(&prem5,"a compl",QDate(2012,1,1),QTime(1,1),Duration(2,0),"paris",QStringList());
//        progF->achieveEvent("a compl");
//        saveAll("../test.xml");
//        loadAll("../test.xml");
        //saveAll("../test.xml");
//    }
